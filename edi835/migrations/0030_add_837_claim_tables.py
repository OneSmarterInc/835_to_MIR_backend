...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(model_name="edi837file", index=models.Index(fields=["client", "-uploaded_at"], name="837_file_client_date_idx")),
        ...
        migrations.AddIndex(model_name="edi837claim", index=models.Index(fields=["client", "claim_control_number"], name="837_claim_control_idx")),
        migrations.AddIndex(model_name="edi837claim", index=models.Index(fields=["client", "highmark_claim_number"], name="837_highmark_idx")),
        migrations.AddIndex(model_name="edi837claim", index=models.Index(fields=["client", "internal_claim_number"], name="837_internal_idx")),
